...
public class GameModeManager : MonoBehaviour
{
    ...
    public void ActivateModeBtn()
    {
        ...
        UnityEngine.UI.Button gameBtn = GameObject.Find("Jogo").GetComponent<UnityEngine.UI.Button>();
        UnityEngine.UI.Button labBtn = GameObject.Find("Lab").GetComponent<UnityEngine.UI.Button>();
